...
openssl req -new -key /etc/nginx/ssl/$1.key -out /etc/nginx/ssl/$1.csr -subj "/CN=$1/O=Borhane/C=UK" 2>/dev/null
...
# echo "updating your hosts file"
# sed -i "/^# The following lines are desirable for IPv6 capable hosts*/ s/^/127.0.0.1       $1\n/" /etc/hosts
# echo "go to http://$1 or https://$1 to visit your new VHOST"
