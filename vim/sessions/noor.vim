...
badd +1 .editorconfig
badd +18 .env
badd +38 config/services.php
badd +1 app/Biology/Providers/Blast.php
badd +94 app/Biology/Parsers/Fasta.php
badd +1 composer.json
badd +6 resources/views/layouts/partials/navbar/_default.blade.php
badd +33 resources/views/layouts/partials/_makeup.blade.php
badd +9 resources/views/layouts/partials/navbar/__navbar_makeup.blade.php
argglobal
silent! argdel *
set stal=2
edit .env
...
silent! normal! zE
let s:l = 20 - ((3 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
normal! 025|
tabedit resources/views/layouts/partials/_makeup.blade.php
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 14 - ((9 * winheight(0) + 8) / 16)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
normal! 0
tabedit app/Biology/Providers/Blast.php
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
