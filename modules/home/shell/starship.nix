  ...
  flake.modules.homeManager.starship =
    ...
    in
    {
      ...
      programs.fish.functions = {
        starship_transient_prompt_func.body = /* fish */ ''
          ${lib.getExe cfg.package} module character
        '';
        starship_transient_rprompt_func.body = /* fish */ ''
          ${lib.getExe cfg.package} module directory
          ${lib.getExe cfg.package} module time
        '';
      };
    };
}
